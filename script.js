...
Message: ${message || "N/A"}`;
    ...
    const phoneNumber = "917338453067";
    window.open(
...
function shareCard() {
  if (navigator.share) {
    navigator
      .share({
        title: "Vidyashree S - Advocate",
        text: "Check out Vidyashree S's digital business card!",
...
FN:Vidyashree S
TITLE:Advocate
TEL;TYPE=CELL:7338453067
X-WHATSAPP;TYPE=CELL:917338453067
END:VCARD`;
  ...
  link.href = url;
  link.download = "Vidyashree S.vcf";
